...
- **Svetlá a tmavá téma** — prepínač slnko/mesiac v hlavičke; prvá návšteva sa riadi systémovou preferenciou, potom sa voľba pamätá v prehliadači. Akcentová farba má picker v režime úprav a žije v dátach (`meta.accent` v `links.js`), takže sa synchronizuje medzi počítačmi — aj animované pozadie sa prefarbí okamžite.
